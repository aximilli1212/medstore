<template>
    <div>
        ...
        <v-layout>
            <v-flex sm5 offset-sm3>
                <v-card color="pa-4 mt-2 round_end elevation-6" id="sale_area">
                    <header>
                        ...
                        <v-layout>
                         ...
                         <span class="mid" >
                   <p class="headline hup">{{csales.company}}</p>
                    <p>Tel: {{company.phone_no}}</p>
                    <p>Outlet: {{csales.outlet}}</p>
                    ...
                    <aside>
                        <v-divider></v-divider>
                        <div class="mid mt-4">
                            <small class="small">{{csales.company_slogan}}</small>
                        </div>
