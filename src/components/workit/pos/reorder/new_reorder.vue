    ...
    <div>
        ...
        <v-card color="primary pa-2 round_end">
            ...
            <v-layout row align-center>
                ...
                <v-flex>
                    <v-tooltip top>
                        <v-btn slot="activator" dark  color="grey darken-3" class="mb-4" :loader="loader" :disable="loader" @click="pullMin"><v-icon left>mdi-arrow-down</v-icon>Pull Minimum </v-btn>
            ...
            <v-layout>
                ...
                <v-flex sm2 md2>
                    <v-btn dark  color="green darken-3" :loader="loader" :disable="loader" @click="$router.push('/reorder_view')"><v-icon left>mdi-redo-variant</v-icon>Send Reorder</v-btn>
