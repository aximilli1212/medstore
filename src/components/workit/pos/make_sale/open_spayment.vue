<template>
    <div>
        ...
        <v-spacer></v-spacer>
        <v-dialog v-model="cpay_dialog" persistent max-width="960px">
            <v-card>
                <v-toolbar dense>
                    <v-toolbar-title class="primary--text">
                        <i class="secondary--text">#{{getCurrentSales.invoice_no}}</i>

                        Make Payment [<i :class="cus_color">{{cus_type}}</i>]
    ...
    export default {
        ...
        watch: {
            ...
            tendered(){
               ...
               if(tend >= 0 && !this.credit_ex){
                   this.sales_payment[0].change = tend.toFixed(4);
                   this.tendSet = false;
               }
               else{
        ...
        methods:{
            ...
            generateInv(){
                ...
                let invoice_no = this.getCurrentSales.invoice_no;
                ...
                axios.post(this.apiSet.cSalePayment, PayData)
            ...
            closeup(){
                ...
                eventBus.$emit('close_cpay',false);
