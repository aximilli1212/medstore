                ...
                <v-card color="pa-4 mt-2 round_end" id="sale_area">
                    ...
                    <article>
                        ...
                        <table class="inventory">
                            <thead>
                            <tr>
                                <th class="name"><span >Product Name</span></th>
                            ...
                            <tr v-for="(prod ,index) in cprod">
                                <td class="name"><span >{{prod.product_name}}</span></td>
                                <td style="text-align:center"><span>{{prod.quantity}}</span></td>
                                <td style="text-align:center"><span >Gh¢ {{prod.price}}</span></td>
                                <td style="text-align:center; width:20px"><span style="width:20px" >Gh¢ {{parseInt(prod.price) * parseInt(prod.quantity)}}</span></td>
                            </tr>
                            </tbody>
                        </table>
                        ...
                        <table class="balance">
                            ...
                            <tr>
                                ...
                                <td class="green--text text--darken-3"><span data-prefix class="headline green--text darken-3">GH¢ </span><span class="headline green--te darken-3">{{csales.total}}</span></td>
                            </tr>
                        </table>
                    </article>
                    <span class="mid">
...
<style lang="scss" scoped>
    ...
    *
    ...
    table.inventory th.name { width: 55%; }

    table.inventory td:nth-child(1) { width: 76%; }
