                        ...
                        <v-card  color="elevation-5 grey lighten-2" class="white--text">
                            ...
                            >
                                ...
                                <v-tooltip top>
                                    <v-btn
                                            slot="activator"
                                            icon @click="barcode_sale">
                                        <v-icon>mdi-barcode-scan</v-icon>
                                    </v-btn>
                                    <span>Find Product Using Barcode</span>
                                </v-tooltip>
                            </v-toolbar>
...
<script>
    ...
    methods:{
        ...
        barcode_sale(){
            this.$router.push('/make_sale_barcode');
            this.$store.commit('setSnack',{t:"Switched to - Search By Barcode", c:"green darken-3"})
        },
            setCashCus(){
                eventBus.$emit('changeCus')
            },
