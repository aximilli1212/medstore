<template>
    <div class="page-invoice scrollable">
        ...
        <div class="invoice">
            <header>
                <h1 style="text-align:center">{{userData.company_name}}</h1>
                <v-layout>
                    <v-flex>
            ...
            <div class="invoice-bottom">
                ...
                <table>
                    ...
                    <tr v-for="(prod ,index) in cprod">
                        ...
                        <td style="text-align:center"><span >{{prod.price}}</span></td>
                    ...
                    <tr>
                        <td></td>
                        <td></td>
                        <td class="Rate"><h2>Total GH¢</h2></td>
                        <td class="payment"><h2> {{csales.total}}</h2></td>
                    </tr>
                    </tfoot>
                </table>
                        ...
                        <p class="head_font pull">
                            <b>Amount Due:</b> <i>{{csales.total}} 2323</i><br />
                            <b>Tendered:</b> {{csales.amount_tendered}} 2323<br />
                            <b>Change Due:</b> {{csales.change_due}} 2323<br />
                            <b>Discount:</b> {{csales.discount}} 2323<br />
...
<style lang="scss" scoped>
    ...
    .page-invoice {
        ...
        .invoice {
            ...
            p  { font-size: 10px; line-height: 1.2em;font-weight:bold }
        }
