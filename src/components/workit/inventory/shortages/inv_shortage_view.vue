<template>
    <div>
        ...
        <v-btn color="secondary" @click="kabimame" small><v-icon left>mdi-printer</v-icon>Print</v-btn>
        <v-card color="pa-4 mt-2 round_end">



            <header>
                <h1>Re-Order Invoice <i class="secondary--text">#{{purchaseDetail.reorder_invoice}}</i></h1>

                <!--<address style="font-size:15px" >-->
                    <!--<p class="headline">Reorder </p>-->
                    <!--<p> Source : {{purchaseDetail.source}}</p>-->
                    <!--<p>  Destination: {{purchaseDetail.destination}}</p>-->
                    <!--<tr>-->
                        <!--<td>#Invoice No.</td>-->
                        <!--<td style="font-weight:bold">{{purchaseDetail.reorder_invoice}}</td>-->
                    <!--</tr>-->
                <!--</address>-->

                <span class="mid" >
                   <p class="headline hup">{{userData.company_name}}</p>
                    <p>Phone No.: {{userData.company_phone_no}}</p>
            ...
            <article>
                ...
                <table class="inventory">
                    ...
                    <tr v-for="(prod ,index) in purrProduct">
                        ...
                        <td><span>{{prod.ws_quantity+'('+prod.ws_unit+') /'+ prod.rt_quantity+'('+prod.rt_unit+')'}}</span></td>
