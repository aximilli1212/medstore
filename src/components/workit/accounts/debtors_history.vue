    ...
    <div>
        ...
        <v-card class="thead">
            <v-card-title>
                ...
                <p class="headline ttext mt-3">Debtors History[ <i class="green--text text--darken-3">{{total}}</i> ]</p>
                <v-spacer></v-spacer>
                <v-text-field
                        v-model="search"
                        append-icon="search"
    ...
    export default {
        ...
        data(){
            return{
                ...
                deb_head: [
                    ...
                    { text: 'Customer Name', align: 'left', value: 'deb_name',class:'subheading' },
        ...
        methods:{
            ...
            loadMyDebs(){
                let self = this;
                this.fetchup = true;
                axios.get(this.apiSet.debHistory)
                    .then(response=>{
